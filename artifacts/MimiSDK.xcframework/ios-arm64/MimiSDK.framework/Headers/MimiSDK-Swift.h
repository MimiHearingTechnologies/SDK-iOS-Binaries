...
SWIFT_RESILIENT_CLASS("_TtC7MimiSDK25MimiProfileViewController")
@interface MimiProfileViewController : MimiViewController
/// :nodoc:
...
@interface MimiProfileViewController (SWIFT_EXTENSION(MimiSDK))
/// :nodoc:
